...
- **[`20260611144600_add_equipment_serial_to_clients.sql`](../../supabase/migrations/20260611144600_add_equipment_serial_to_clients.sql):** Nova migração SQL adicionando a coluna `equipment_serial` à tabela `public.clients`.
- **[`types.ts`](../../src/integrations/supabase/types.ts):** Atualizado as definições de tipo TypeScript do Supabase para refletir a coluna `equipment_serial` (nos objetos `Row`, `Insert` e `Update`).
...
- **[`ServiceCallForm.tsx`](../../src/components/ServiceCallForm.tsx):**
